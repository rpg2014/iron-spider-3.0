...
import {
    ...
    VerifyRegistrationInput, VerifyRegistrationOutput
...
export const VerifyRegistrationOperation: Operation<VerifyRegistrationInput, VerifyRegistrationOutput, HandlerContext> = async (
    input,
    context
) => {
