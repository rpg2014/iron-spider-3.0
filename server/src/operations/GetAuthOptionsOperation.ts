...
import {
    ...
    GenerateAuthenticationOptionsOutput,
    BadRequestError
...
export const GetAuthOptionsOperation: Operation<GenerateAuthenticationOptionsInput, GenerateAuthenticationOptionsOutput, HandlerContext> =
  async (input, context) => {
